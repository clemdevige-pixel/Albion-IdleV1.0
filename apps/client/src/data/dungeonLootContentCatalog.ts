...
export const KEEPER_T8_DUNGEON_LOOT = createFactionLootDefinition(KEEPER_T8_LOOT_TABLE_ID, "Keeper", "keeper", T8_FACTION_ENCOUNTER_LOOT);
export const HERETIC_T8_DUNGEON_LOOT = createFactionLootDefinition(HERETIC_T8_LOOT_TABLE_ID, "Heretic", "heretic", T8_FACTION_ENCOUNTER_LOOT);
export const UNDEAD_T8_DUNGEON_LOOT = createFactionLootDefinition(UNDEAD_T8_LOOT_TABLE_ID, "Undead", "undead", T8_FACTION_ENCOUNTER_LOOT);
export const MORGANA_T8_DUNGEON_LOOT = createFactionLootDefinition(MORGANA_T8_LOOT_TABLE_ID, "Morgana", "morgana", T8_FACTION_ENCOUNTER_LOOT);
