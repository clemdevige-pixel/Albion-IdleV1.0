...
const T5_FACTION_ENCOUNTER_LOOT: Readonly<Record<DungeonEncounterKind, DungeonEncounterLootDefinition>> = {
  normal: { artifactFragmentQuantity: 5, artifactDropChance: 0 },
  elite: { artifactFragmentQuantity: 12, artifactDropChance: 0 },
  boss: { artifactFragmentQuantity: 34, artifactDropChance: 0.12 },
};
...
export const DUNGEON_LOOT_DEFINITIONS: Readonly<Record<string, DungeonLootDefinition>> = Object.fromEntries(
  [
    ...
    KEEPER_T5_DUNGEON_LOOT,
    HERETIC_T5_DUNGEON_LOOT,
    UNDEAD_T5_DUNGEON_LOOT,
    MORGANA_T5_DUNGEON_LOOT,
