...
export const FACTION_ARTIFACT_WEAPON_CONTENT: readonly FactionArtifactWeaponSpecializationContent[] = [
  ...
  { familyId: "sword", specializationMasteryId: "mastery_carving_sword", specializationName: "Carving Sword", combatProfile: "sword", attackSpeed: 1.15, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.carvingFearlessStrike, craft: { kind: "artifact_pending" }, items: physicalItems("sword_carving", "two_handed", [102, 148, 215, 312, 452], 260) },
  ...
  { familyId: "bow", specializationMasteryId: "mastery_wailing_bow", specializationName: "Wailing Bow", combatProfile: "bow", attackSpeed: 1.00, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.wailingDemonArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_wailing", "two_handed", [139, 200, 290, 422, 611], 260) },
  ...
  { familyId: "bow", specializationMasteryId: "mastery_warbow", specializationName: "Warbow", combatProfile: "bow", attackSpeed: 1.15, artifactFaction: "Heretic", signatureAbility: FACTION_ARTIFACT_ABILITIES.warbowMagicArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_warbow", "two_handed", [116, 168, 243, 353, 512], 260) },
