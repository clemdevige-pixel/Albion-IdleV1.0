...
export const FACTION_ARTIFACT_ABILITIES = {
  ...
  deathgiversGhostStrike: ability({ id: "ability_dagger_deathgivers_ghost_strike", name: "Ghost Strike", description: "Une frappe magique lourde déclenchée lorsque Rafale de lames a ouvert la garde.", icon: "🗡️", category: "active", cooldown: 16, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "magical" }, { autoRule: { kind: "target_has_effect", effectId: "effect_dagger_opening" }, mechanics: [{ kind: "damage", ratio: 1.8, scalingDamageType: "physical", bonusEffect: { effectId: "effect_dagger_opening", bonusRatio: 2.5 } }] }),
...
export const FACTION_ARTIFACT_WEAPON_CONTENT: readonly FactionArtifactWeaponSpecializationContent[] = [
  ...
  { familyId: "bow", specializationMasteryId: "mastery_bow_of_badon", specializationName: "Bow of Badon", combatProfile: "bow", attackSpeed: 1.00, artifactFaction: "Keeper", signatureAbility: FACTION_ARTIFACT_ABILITIES.badonRagingStorm, craft: { kind: "artifact_pending" }, items: physicalItems("bow_bow_of_badon", "two_handed", [118, 171, 248, 360, 522], 260) },
