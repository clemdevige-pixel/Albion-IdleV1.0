...
export const FACTION_ARTIFACT_ABILITIES = {
  ...
  whisperingUndeadArrows: ability({ id: "ability_bow_whispering_undead_arrows", name: "Undead Arrows", description: "Renforce temporairement la cadence et les auto-attaques au prix d'une vulnérabilité accrue.", icon: "🏹", category: "active", cooldown: 22, castTime: 0, resourceCost: {}, interruptible: true, targetRule: "current_target", damageType: "physical" }, { mechanics: [
    ...
    { kind: "auto_attack_bonus_window", effectId: "effect_bow_whispering_bonus_damage", duration: 6, ratio: 0.4, damageType: "magical", scalingDamageType: "physical" },
  ] }),
...
export const FACTION_ARTIFACT_WEAPON_CONTENT: readonly FactionArtifactWeaponSpecializationContent[] = [
  ...
  { familyId: "bow", specializationMasteryId: "mastery_wailing_bow", specializationName: "Wailing Bow", combatProfile: "bow", attackSpeed: 0.95, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.wailingDemonArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_wailing", "two_handed", [122, 176, 256, 372, 539], 260) },
  { familyId: "bow", specializationMasteryId: "mastery_whispering_bow", specializationName: "Whispering Bow", combatProfile: "bow", attackSpeed: 1.15, artifactFaction: "Undead", signatureAbility: FACTION_ARTIFACT_ABILITIES.whisperingUndeadArrows, craft: { kind: "artifact_pending" }, items: physicalItems("bow_whispering", "two_handed", [100, 144, 209, 303, 440], 260) },
  { familyId: "bow", specializationMasteryId: "mastery_warbow", specializationName: "Warbow", combatProfile: "bow", attackSpeed: 1.10, artifactFaction: "Heretic", signatureAbility: FACTION_ARTIFACT_ABILITIES.warbowMagicArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_warbow", "two_handed", [104, 151, 218, 317, 460], 260) },
