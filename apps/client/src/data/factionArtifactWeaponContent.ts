...
export const FACTION_ARTIFACT_WEAPON_CONTENT: readonly FactionArtifactWeaponSpecializationContent[] = [
  ...
  { familyId: "bow", specializationMasteryId: "mastery_wailing_bow", specializationName: "Wailing Bow", combatProfile: "bow", attackSpeed: 0.95, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.wailingDemonArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_wailing", "two_handed", [145, 200, 290, 422, 611], 260) },
