...
export const FACTION_ARTIFACT_ABILITIES = {
  ...
  whisperingUndeadArrows: ability({ id: "ability_bow_whispering_undead_arrows", name: "Undead Arrows", description: "Renforce temporairement la cadence et les auto-attaques au prix d'une vulnérabilité accrue.", icon: "🏹", category: "active", cooldown: 22, castTime: 0, resourceCost: {}, interruptible: true, targetRule: "current_target", damageType: "physical" }, { mechanics: [
    { kind: "status", target: "self", effectId: "effect_bow_whispering_attack_speed", effectType: "buff", duration: 6, statId: "stat_attack_speed", statDelta: 20, modifierType: "percent" },
    ...
    { kind: "auto_attack_bonus_window", effectId: "effect_bow_whispering_bonus_damage", duration: 6, ratio: 0.35, damageType: "magical", scalingDamageType: "physical" },
  ] }),
  warbowMagicArrow: ability({ id: "ability_bow_warbow_magic_arrow", name: "Magic Arrow", description: "Une flèche magique à fort impact et faible temps de recharge.", icon: "🏹", category: "active", cooldown: 20, castTime: 0, resourceCost: {}, interruptible: true, targetRule: "current_target", damageType: "magical" }, { mechanics: [{ kind: "damage", ratio: 2.0, scalingDamageType: "physical" }] }),
  ...
  battleBracersFalconSmash: ability({ id: "ability_gloves_battle_bracers_falcon_smash", name: "Falcon Smash", description: "Un assaut brutal concentré sur le burst physique.", icon: "🥊", category: "active", cooldown: 26, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { mechanics: [{ kind: "damage", ratio: 2.35 }] }),

  bloodletterLungingStabs: ability({ id: "ability_dagger_bloodletter_lunging_stabs", name: "Lunging Stabs", description: "Une frappe d'exécution dont la puissance double sous 40% de vie cible.", icon: "🗡️", category: "active", cooldown: 24, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { autoRule: { kind: "target_health_below", ratio: 0.4 }, mechanics: [{ kind: "damage", ratio: 1.3, bonusHealthBelow: { ratio: 0.4, bonusRatio: 1.3 } }] }),
  demonfangBloodRitual: ability({ id: "ability_dagger_demonfang_blood_ritual", name: "Blood Ritual", description: "Trois frappes magiques rapides alimentées par la puissance physique de l'arme.", icon: "🗡️", category: "active", cooldown: 24, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "magical" }, { mechanics: [{ kind: "damage", ratio: 0.72, hits: 3, scalingDamageType: "physical" }] }),
  deathgiversGhostStrike: ability({ id: "ability_dagger_deathgivers_ghost_strike", name: "Ghost Strike", description: "Une frappe magique renforcée contre une cible dont la garde est ouverte.", icon: "🗡️", category: "active", cooldown: 22, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "magical" }, { mechanics: [{ kind: "damage", ratio: 1.65, scalingDamageType: "physical", bonusEffect: { effectId: "effect_dagger_opening", bonusRatio: 0.9 } }] }),
  clawsDisembowel: ability({ id: "ability_dagger_claws_disembowel", name: "Disembowel", description: "Une série de coups qui immobilise brièvement puis fait saigner la cible.", icon: "🗡️", category: "active", cooldown: 26, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { mechanics: [{ kind: "damage", ratio: 0.32, hits: 4 }, { kind: "status", effectId: "effect_dagger_claws_stun", effectType: "stun", duration: 1.25 }, { kind: "dot", effectId: "effect_dagger_claws_bleed", ratio: 0.15, interval: 1, ticks: 3 }] }),
} as const;
...
export const FACTION_ARTIFACT_WEAPON_CONTENT: readonly FactionArtifactWeaponSpecializationContent[] = [
  { familyId: "sword", specializationMasteryId: "mastery_clarent_blade", specializationName: "Clarent Blade", combatProfile: "sword", attackSpeed: 1.25, artifactFaction: "Keeper", signatureAbility: FACTION_ARTIFACT_ABILITIES.clarentCrescentSlash, craft: { kind: "artifact_pending" }, items: physicalItems("sword_clarent", "one_handed", [89, 129, 187, 271, 393], 260) },
  { familyId: "sword", specializationMasteryId: "mastery_carving_sword", specializationName: "Carving Sword", combatProfile: "sword", attackSpeed: 1.10, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.carvingFearlessStrike, craft: { kind: "artifact_pending" }, items: physicalItems("sword_carving", "two_handed", [102, 148, 215, 312, 452], 260) },
  ...
  { familyId: "bow", specializationMasteryId: "mastery_wailing_bow", specializationName: "Wailing Bow", combatProfile: "bow", attackSpeed: 0.95, artifactFaction: "Morgana", signatureAbility: FACTION_ARTIFACT_ABILITIES.wailingDemonArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_wailing", "two_handed", [116, 168, 244, 354, 513], 260) },
  { familyId: "bow", specializationMasteryId: "mastery_whispering_bow", specializationName: "Whispering Bow", combatProfile: "bow", attackSpeed: 1.15, artifactFaction: "Undead", signatureAbility: FACTION_ARTIFACT_ABILITIES.whisperingUndeadArrows, craft: { kind: "artifact_pending" }, items: physicalItems("bow_whispering", "two_handed", [94, 136, 197, 286, 415], 260) },
  { familyId: "bow", specializationMasteryId: "mastery_warbow", specializationName: "Warbow", combatProfile: "bow", attackSpeed: 1.10, artifactFaction: "Heretic", signatureAbility: FACTION_ARTIFACT_ABILITIES.warbowMagicArrow, craft: { kind: "artifact_pending" }, items: physicalItems("bow_warbow", "two_handed", [100, 145, 210, 305, 442], 260) },

  { familyId: "fire_staff", specializationMasteryId: "mastery_wildfire_staff", specializationName: "Wildfire Staff", combatProfile: "staff", attackSpeed: 0.95, artifactFaction: "Keeper", signatureAbility: FACTION_ARTIFACT_ABILITIES.wildfireMagmaSphere, craft: { kind: "artifact_pending" }, items: magicalItems("staff_wildfire", [118, 171, 248, 360, 522], 280) },
