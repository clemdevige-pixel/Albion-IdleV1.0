...
export const MONSTER_DEFINITIONS: Readonly<Record<string, MonsterContentDefinition>> = {
  ...
  [MONSTER_IDS.morganaWitch]: {
    ...
    rewards: {
      silverMultiplier: 1,
      fameMultiplier: 1,
      lootTableId: "loot_morgana_normal",
    },
    abilityIds: [MONSTER_ABILITY_IDS.morganaWitchShadowBolt],
    tags: ["morgana", "caster", "ranged"],
  },
  [MONSTER_IDS.morganaSuppressor]: {
    id: MONSTER_IDS.morganaSuppressor,
    name: "Morgana Suppressor",
    faction: "Morgana",
    category: "normal",
    tier: 3,
    ...
    abilityIds: [MONSTER_ABILITY_IDS.morganaSuppressorBolt],
    tags: ["morgana", "ranged", "crossbow"],
  },
  [MONSTER_IDS.morganaDarkKnight]: {
    id: MONSTER_IDS.morganaDarkKnight,
    name: "Morgana Dark Knight",
    faction: "Morgana",
    category: "elite",
    tier: 3,
  ...
  [MONSTER_IDS.undeadSkeletonSwordsman]: {
    ...
    rewards: { silverMultiplier: 1, fameMultiplier: 1, lootTableId: "loot_undead_normal" },
    abilityIds: [],
  ...
  [MONSTER_IDS.undeadSpectralKnight]: {
    ...
    rewards: { silverMultiplier: 1.4, fameMultiplier: 1.4, lootTableId: "loot_undead_elite" },
    abilityIds: [MONSTER_ABILITY_IDS.spectralKnightSoulCleave, MONSTER_ABILITY_IDS.spectralKnightPhantomStrike],
  ...
  [MONSTER_IDS.undeadLich]: {
    ...
    rewards: { silverMultiplier: 1.8, fameMultiplier: 1.8, lootTableId: "loot_undead_boss" },
    abilityIds: [MONSTER_ABILITY_IDS.lichSoulBolt, MONSTER_ABILITY_IDS.lichDeathWave],
...
export const ZONE_ENCOUNTER_POOLS: Readonly<Record<string, ZoneEncounterPool>> = {
  ...
  zone_mountain_t4: { normal: CURRENT_NORMAL_POOL, segmentBoss: MONSTER_IDS.undeadWarrior, biomeBoss: MONSTER_IDS.ancientRuneGolem },
};
