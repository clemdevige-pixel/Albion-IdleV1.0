...
export const PRODUCTION_TIER_RULES = {
  ...
  4: { gatheringBaseTicks: 36, gatheringToolSpeedModifier: 0.85, workerSpeedModifier: 0.75, resourceRespawnDurationTicks: 360 },
  5: { gatheringBaseTicks: 48, gatheringToolSpeedModifier: 1, workerSpeedModifier: 1, resourceRespawnDurationTicks: 360 },
  6: { gatheringBaseTicks: 60, gatheringToolSpeedModifier: 1, workerSpeedModifier: 1, resourceRespawnDurationTicks: 360 },
  7: { gatheringBaseTicks: 72, gatheringToolSpeedModifier: 1, workerSpeedModifier: 1, resourceRespawnDurationTicks: 360 },
  8: { gatheringBaseTicks: 84, gatheringToolSpeedModifier: 1, workerSpeedModifier: 1, resourceRespawnDurationTicks: 360 },
} as const satisfies Record<ProductionTier, ProductionTierRules>;

export function getProductionTierRules(tier: ProductionTier): ProductionTierRules { return PRODUCTION_TIER_RULES[tier]; }
