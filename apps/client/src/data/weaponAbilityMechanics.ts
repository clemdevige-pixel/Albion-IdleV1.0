...
export const WEAPON_ABILITY_MECHANICS: Readonly<Record<string, AbilityMechanicsProfile>> = {
  ...
  ability_bow_aimed_shot: { mechanics: [{ kind: "damage", ratio: 0.6 }] },
  ability_bow_piercing_arrow: { mechanics: [{ kind: "damage", ratio: 0.8 }, { kind: "status", effectId: "effect_bow_pierce", effectType: "debuff", duration: 4, statId: "stat_armor", statDelta: -8 }] },
  ...
  ability_fire_fireball: { mechanics: [{ kind: "damage", ratio: 0.45 }, { kind: "dot", effectId: "effect_fire_burn", ratio: 0.08, interval: 1, ticks: 3 }] },
  ability_fire_infernal_burst: { autoRule: { kind: "target_has_effect", effectId: "effect_fire_burn" }, mechanics: [{ kind: "damage", ratio: 0.8, bonusEffect: { effectId: "effect_fire_burn", bonusRatio: 0.35 } }] },
  ...
  ability_gloves_shockwave: { mechanics: [{ kind: "damage", ratio: 0.8 }] },
  ability_gloves_breaking_combo: { mechanics: [{ kind: "damage", ratio: 1, hits: 3 }] },
  ...
  ability_dagger_double_slash: { mechanics: [{ kind: "damage", ratio: 0.5, hits: 2 }] },
  ability_dagger_flurry: { mechanics: [{ kind: "damage", ratio: 0.8, hits: 4 }, { kind: "status", effectId: "effect_dagger_opening", effectType: "debuff", duration: 4 }] },
