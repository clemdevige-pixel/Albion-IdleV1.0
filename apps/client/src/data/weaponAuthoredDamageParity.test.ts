...
describe("weapon authored damage parity", () => {
  ...
  it("keeps the current authored T3 two-handed baselines in weapon data", () => {
    expect(WEAPON_ITEM_DEFINITIONS["item_weapon_bow_t3_longbow"]?.stats?.stat_physical_damage).toBe(66.5);
