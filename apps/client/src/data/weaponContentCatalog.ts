...
const ABILITIES = {
  ...
  infernalCataclysm: defineWeaponAbility({ id: "ability_fire_cataclysm", name: "Cataclysme", description: "Le bâton libère une attaque magique massive qui consume la cible dans le temps.", icon: "🌋", category: "active", cooldown: 14, castTime: 0, resourceCost: {}, interruptible: true, targetRule: "current_target", damageType: "magical" }, { mechanics: [{ kind: "damage", ratio: 1.42 }, { kind: "dot", effectId: "effect_fire_cataclysm", ratio: 0.18, interval: 1, ticks: 5 }] }),
  ...
  daggerDoubleSlash: defineWeaponAbility({ id: "ability_dagger_double_slash", name: "Double entaille", description: "Les deux lames frappent rapidement la cible.", icon: "🗡️", category: "active", cooldown: 4, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { mechanics: [{ kind: "damage", ratio: 0.79, hits: 2 }] }),
  daggerFlurry: defineWeaponAbility({ id: "ability_dagger_flurry", name: "Rafale de lames", description: "Une rafale de coups ouvre la garde et prépare la prochaine attaque signature.", icon: "⚔", category: "active", cooldown: 8, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { mechanics: [{ kind: "damage", ratio: 1.04, hits: 4 }, { kind: "status", effectId: "effect_dagger_opening", effectType: "debuff", duration: 4, statId: "stat_auto_attack_damage_taken_bonus", statDelta: 10 }, { kind: "status", effectId: "effect_dagger_combo_ready", effectType: "debuff", duration: 12 }] }),
  daggerPairCrossAssault: defineWeaponAbility({ id: "ability_dagger_pair_cross_assault", name: "Assaut croisé", description: "Deux frappes croisées qui consomment l'ouverture préparée par Rafale de lames.", icon: "🗡️", category: "active", cooldown: 8, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { autoRule: { kind: "target_has_effect", effectId: "effect_dagger_combo_ready" }, mechanics: [{ kind: "damage", ratio: 1.85, hits: 2, bonusEffect: { effectId: "effect_dagger_combo_ready", bonusRatio: 0.95 } }, { kind: "consume_effect", effectId: "effect_dagger_combo_ready" }] }),
