...
const ABILITIES = {
  ...
  broadswordExecution: defineWeaponAbility({ id: "ability_sword_execution", name: "Exécution", description: "Une frappe de finition renforcée contre les cibles affaiblies.", icon: "💥", category: "active", cooldown: 28, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { autoRule: { kind: "target_health_below", ratio: 0.5 }, mechanics: [{ kind: "damage", ratio: 1.55, bonusHealthBelow: { ratio: 0.5, bonusRatio: 0.75 } }] }),
  ...
  daggerPairCrossAssault: defineWeaponAbility({ id: "ability_dagger_pair_cross_assault", name: "Assaut croisé", description: "Deux frappes croisées renforcées lorsque Rafale de lames a ouvert la garde.", icon: "🗡️", category: "active", cooldown: 15, castTime: 0, resourceCost: {}, interruptible: false, targetRule: "current_target", damageType: "physical" }, { mechanics: [{ kind: "damage", ratio: 1.35, hits: 2, bonusEffect: { effectId: "effect_dagger_opening", bonusRatio: 0.45 } }] }),
