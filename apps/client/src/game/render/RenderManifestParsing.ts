...
export function requireString(
  ...
  if (typeof value !== "string" || value.length === 0) {
    throw new Error(
      `${context}.${key} doit être une chaîne non vide`,
    );
  }
...
export function parseDisplay(
  ...
  if (width <= 0 || height <= 0) {
    throw new Error(
      `${context} doit définir des dimensions positives`,
    );
  }
...
export function parseWorldStatusText(
  value: unknown,
  context: string,
...
export function parseActorRenderManifest(
  value: unknown,
): ActorRenderManifest {
  if (!isRecord(value)) {
    throw new Error(
      "Le manifeste de rendu doit être un objet",
    );
  }

  if (value["schemaVersion"] !== 1) {
    throw new Error(
      "Version de manifeste de rendu non supportée",
    );
  }

  if (value["kind"] !== "actor") {
    throw new Error(
      "Le manifeste doit être de type actor",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "origin, offset et animations sont obligatoires",
    );
  }
  ...
  if (!isRecord(visualParameters)) {
    throw new Error(
      "visualParameters est obligatoire",
    );
  }
...
export function parseStaticActorRenderManifest(
  value: unknown,
): StaticActorRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
    throw new Error(
      "Manifeste statique invalide ou non supporté",
    );
  }

  if (value["kind"] !== "static_actor") {
    throw new Error(
      "Le manifeste doit être de type static_actor",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "origin, offset et hud sont obligatoires",
    );
  }
  ...
  return {
    ...
    hud: {
      healthBarWidth: requireNumber(
        hud,
        "healthBarWidth",
        "hud",
      ),
      healthBarOffsetY: requireNumber(
        hud,
        "healthBarOffsetY",
        "hud",
      ),
...
export function parseResourceNodeRenderManifest(
  value: unknown,
): ResourceNodeRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
    throw new Error(
      "Manifeste de ressource invalide ou non supporté",
    );
  }

  if (value["kind"] !== "resource_node") {
    throw new Error(
      "Le manifeste doit être de type resource_node",
    );
  }
  ...
  if (!isRecord(origin) || !isRecord(offset)) {
    throw new Error(
      "origin et offset sont obligatoires",
    );
  }
...
export function parseFloatingTextRenderManifest(
  value: unknown,
  ...
  if (value["kind"] !== "floating_text") {
    throw new Error(
      "Le manifeste doit être de type floating_text",
    );
  }
  ...
  if (!isRecord(textStyle) || !isRecord(motion)) {
    throw new Error(
      "textStyle et motion sont obligatoires",
    );
  }
  ...
  return {
    ...
    motion: {
      randomOffsetX: requireNumber(
        motion,
        "randomOffsetX",
        "motion",
      ),
      riseDistance: requireNumber(
        motion,
        "riseDistance",
        "motion",
      ),
      startScale: requireNumber(
        motion,
        "startScale",
        "motion",
      ),
      endScale: requireNumber(
        motion,
        "endScale",
        "motion",
      ),
      durationMs: requireNumber(
        motion,
        "durationMs",
        "motion",
      ),
...
function requireColorPair(
  ...
  if (
    ...
    throw new Error(
      `${context} doit contenir deux couleurs`,
    );
  }
...
export function parseWorldHudRenderManifest(
  value: unknown,
): WorldHudRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
  ...
  if (
    ...
    throw new Error(
      "Structure du manifeste world_hud invalide",
    );
  }
  ...
  return {
    ...
    healthBar: {
      ...
      backgroundDepth: requireNumber(
        healthBar,
        "backgroundDepth",
        "healthBar",
      ),
      fillDepth: requireNumber(
        healthBar,
        "fillDepth",
        "healthBar",
      ),
      lowerGradient: requireColorPair(
        healthBar["lowerGradient"],
        "lowerGradient",
      ),
      upperGradient: requireColorPair(
        healthBar["upperGradient"],
        "upperGradient",
      ),
    },
    ...
    actorLabel: {
      ...
      playerColor: requireString(
        actorLabel,
        "playerColor",
        "actorLabel",
      ),
      enemyColor: requireString(
        actorLabel,
        "enemyColor",
        "actorLabel",
      ),
      letterSpacing: requireNumber(
        actorLabel,
        "letterSpacing",
        "actorLabel",
      ),
...
export function parseWorldStatusRenderManifest(
  value: unknown,
): WorldStatusRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
    throw new Error(
      "Manifeste de statut du monde invalide",
    );
  }

  if (value["kind"] !== "world_status") {
    throw new Error(
      "Le manifeste doit être de type world_status",
    );
  }
  ...
  return {
    ...
    id: requireString(value, "id", "manifest"),
    kind: "world_status",
    zoneText: parseWorldStatusText(
      value["zoneText"],
      "zoneText",
    ),
    segmentText: parseWorldStatusText(
      value["segmentText"],
      "segmentText",
    ),
    stateText: parseWorldStatusText(
      value["stateText"],
      "stateText",
    ),
  };
}
export function parseProjectileRenderManifest(
  value: unknown,
): ProjectileRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
    throw new Error(
      "Manifeste de projectile invalide ou non supporté",
    );
  }

  if (value["kind"] !== "projectile") {
    throw new Error(
      "Le manifeste doit être de type projectile",
    );
  }
  ...
  if (!isRecord(shape)) {
    throw new Error(
      "projectile.shape est obligatoire",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "projectile.trajectory linear est obligatoire",
    );
  }

  const shapeType = requireString(
    shape,
    "type",
    "shape",
  );
  ...
  if (parsedShape === undefined) {
    throw new Error(
      `Forme de projectile non supportée : ${shapeType}`,
    );
  }
  ...
  const parsedImpact = isRecord(impact)
    ? {
        ...
        fillColor: requireString(
          impact,
          "fillColor",
          "impactEffect",
        ),
        fillAlpha: requireNumber(
          impact,
          "fillAlpha",
          "impactEffect",
        ),
        strokeWidth: requireNumber(
          impact,
          "strokeWidth",
          "impactEffect",
        ),
  ...
  if (
    ...
    throw new Error(
      `Mode de fusion non supporté : ${blendMode}`,
    );
  }
  ...
  return {
    ...
    ...(parsedImpact === undefined
      ? {}
      : { impactEffect: parsedImpact }),
  };
}

function parseEnvironmentPalette(
  value: unknown,
  context: string,
  ...
  return {
    ...
    ground: requireString(
      value,
      "ground",
      context,
    ),
    groundLine: requireString(
      value,
      "groundLine",
      context,
    ),
...
export function parseEnvironmentRenderManifest(
  value: unknown,
): EnvironmentRenderManifest {
  if (!isRecord(value) || value["schemaVersion"] !== 1) {
    throw new Error(
      "Manifeste d’environnement invalide ou non supporté",
    );
  }

  if (value["kind"] !== "environment") {
    throw new Error(
      "Le manifeste doit être de type environment",
    );
  }
  ...
  if (!isRecord(layout) || !isRecord(defaultPalette)) {
    throw new Error(
      "layout et defaultPalette sont obligatoires",
    );
  }
  ...
  return {
    ...
    defaultPalette: parseEnvironmentPalette(
      defaultPalette,
      "defaultPalette",
    ),

    biomePalettes: Object.fromEntries(
      Object.entries(biomePalettes).map(
        ([key, palette]) => [
          key,
          parseEnvironmentPalette(
            palette,
            `biomePalettes.${key}`,
          ),
        ],
    ...
    layout: {
      ...
      skyYRatio: requireNumber(
        layout,
        "skyYRatio",
        "layout",
      ),

      groundHeightRatio: requireNumber(
        layout,
        "groundHeightRatio",
        "layout",
      ),

      groundYRatio: requireNumber(
        layout,
        "groundYRatio",
        "layout",
      ),

      groundLineYRatio: requireNumber(
        layout,
        "groundLineYRatio",
        "layout",
      ),

      actorShadowWidth: requireNumber(
        layout,
        "actorShadowWidth",
        "layout",
      ),

      actorShadowHeight: requireNumber(
        layout,
        "actorShadowHeight",
        "layout",
      ),

      actorShadowYRatio: requireNumber(
        layout,
        "actorShadowYRatio",
        "layout",
      ),
