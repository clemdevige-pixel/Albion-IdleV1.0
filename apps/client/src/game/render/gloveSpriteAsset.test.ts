...
const ASSET_PATHS = [
  "/assets/characters/hero-ursine-attack-normalized-v1.png",
  "/assets/characters/hero-spiked-attack-normalized-v1.png",
  "/assets/characters/hero-battle-bracers-attack-normalized-v1.png",
  "/assets/characters/hero-hellfire-hands-attack-normalized-v1.png",
  "/assets/characters/hero-ravenstrike-cestus-attack-normalized-v1.png",
] as const;
...
describe("normalized glove sprite assets", () => {
