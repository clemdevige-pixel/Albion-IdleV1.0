...
const ITEM_VISUALS: Readonly<Record<string, ItemVisualDefinition>> = {
  ...
  item_weapon_bow_t3_longbow: { name: "Arc long T3", icon: "item-longbow-pixel-v1.png", tier: 3, slot: "weapon", handling: "two_handed", stats: { stat_physical_damage: 40 } },
  item_weapon_staff_t3_fire: { name: "Bâton de feu T3", icon: "item-fire-staff-pixel-v1.png", tier: 3, slot: "weapon", handling: "two_handed", stats: { stat_magical_damage: 45 } },
  item_weapon_gloves_t3_spiked_gauntlets: { name: "Gantelets à pointes T3", icon: "item-spiked-gauntlets-pixel-v1.png", tier: 3, slot: "weapon", handling: "two_handed", stats: { stat_physical_damage: 34 } },
  ...
  item_weapon_bow_t4_longbow: { name: "Arc long T4", icon: "item-longbow-pixel-v1.png", tier: 4, slot: "weapon", handling: "two_handed", stats: { stat_physical_damage: 68 } },
  item_weapon_bow_t4_badon: { name: "Badon T4", icon: "item-badon-pixel-v1.png", tier: 4, slot: "weapon", handling: "two_handed", stats: { stat_physical_damage: 72 } },
  item_weapon_staff_t4_fire: { name: "Bâton de feu T4", icon: "item-fire-staff-pixel-v1.png", tier: 4, slot: "weapon", handling: "two_handed", stats: { stat_magical_damage: 85 } },
  item_weapon_gloves_t4_spiked_gauntlets: { name: "Gantelets à pointes T4", icon: "item-spiked-gauntlets-pixel-v1.png", tier: 4, slot: "weapon", handling: "two_handed", stats: { stat_physical_damage: 58 } },
