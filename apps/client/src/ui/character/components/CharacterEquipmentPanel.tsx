...
export function CharacterEquipmentPanel({
  ...
  }, [compact, heroIdle.image, heroIdle.spriteSheet, heroIdleFrameIndex, heroIdleFrameWidth, heroIdleFrameHeight]);
  ...
  return (
    <section className={`character-module__equipment${compact ? " character-module__equipment--compact" : ""}`} aria-label="Équipement actuel">
      {title !== undefined ? <h3 className="character-module__equipment-title">{title}</h3> : null}
      ...
      {compact ? (
        <div className="character-module__loadout character-module__loadout--compact">
