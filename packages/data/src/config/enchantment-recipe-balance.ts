export type AuthoredEnchantmentLevel = 1 | 2 | 3 | 4;
...
export const ENCHANTMENT_SHARD_COSTS: Readonly<Record<AuthoredEnchantmentLevel, number>> = {
  1: 10,
  2: 30,
  3: 60,
  4: 100,
...
export const ENCHANTMENT_CRAFT_MATERIAL_MULTIPLIERS: Readonly<Record<AuthoredEnchantmentLevel, number>> = {
  1: 1,
  2: 2,
  3: 4,
  4: 8,
...
export interface AuthoredEnchantmentRecipeStep {
  ...
  readonly toLevel: AuthoredEnchantmentLevel;
  readonly enabled: boolean;
  readonly silverCost: number;
}

/** Base Silver steps before tier/category scaling. */
export const ENCHANTMENT_RECIPE_STEPS: Readonly<Record<AuthoredEnchantmentLevel, AuthoredEnchantmentRecipeStep>> = {
