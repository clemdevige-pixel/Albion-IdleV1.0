...
export const AUTHORED_WORKER_DEFINITIONS = [
  { id: "worker_woodcutter_t3", displayName: "Edda", displayNames: ["Edda", "Toren"], profession: "woodcutter", baseMasteryGainRate: 1, tags: ["gathering", "wood"] },
  { id: "worker_miner_t3", displayName: "Borin", displayNames: ["Borin", "Dagr"], profession: "miner", baseMasteryGainRate: 1, tags: ["gathering", "ore"] },
  { id: "worker_skinner_t3", displayName: "Mira", displayNames: ["Mira", "Sela"], profession: "skinner", baseMasteryGainRate: 1, tags: ["gathering", "hide"] },
  { id: "worker_fiber_harvester_t3", displayName: "Lina", displayNames: ["Lina", "Neris"], profession: "fiber_harvester", baseMasteryGainRate: 1, tags: ["gathering", "fiber"] },
] as const satisfies readonly AuthoredWorkerDefinition[];

export const AUTHORED_WORKER_TASK_DEFINITIONS = [
  { id: "worker_gather_wood_t3", displayName: "Récolter du bois de bouleau", category: "gathering", requiredProfession: "woodcutter", durationTicks: 60, baseYield: 1, resourceTier: 3, tags: ["wood", "birch"] },
  { id: "worker_gather_copper_t3", displayName: "Extraire du minerai de cuivre", category: "gathering", requiredProfession: "miner", durationTicks: 60, baseYield: 1, resourceTier: 3, tags: ["ore", "copper"] },
  { id: "worker_gather_hide_t3", displayName: "Dépecer des peaux robustes", category: "gathering", requiredProfession: "skinner", durationTicks: 60, baseYield: 1, resourceTier: 3, tags: ["hide", "leather"] },
  { id: "worker_gather_fiber_t3", displayName: "Récolter des fibres de lin", category: "gathering", requiredProfession: "fiber_harvester", durationTicks: 60, baseYield: 1, resourceTier: 3, tags: ["fiber", "cloth"] },
